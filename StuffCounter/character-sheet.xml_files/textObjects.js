function calcTalentSpecs(){
	...
	if (highest > 0)
		document.getElementById('talentSpecImage').src = "/_images/icons/class/"+ theClassId +"/talents/"+ highest +".gif";
	else if (highest == 0)
		document.getElementById('talentSpecImage').src = "/_images/icons/class/talents/hybrid.gif";
	else
		document.getElementById('talentSpecImage').src = "/_images/icons/class/talents/untalented.gif";
	...
	try{
		...
		if(document.getElementById("talentSpecImage2")){
			...
			if (highest > 0)
				document.getElementById('talentSpecImage2').src = "/_images/icons/class/"+ theClassId +"/talents/"+ highest +".gif";
			else if (highest == 0)
				document.getElementById('talentSpecImage2').src = "/_images/icons/class/talents/hybrid.gif";
			else
				document.getElementById('talentSpecImage2').src = "/_images/icons/class/talents/untalented.gif";		
		}
	}catch(e){}
