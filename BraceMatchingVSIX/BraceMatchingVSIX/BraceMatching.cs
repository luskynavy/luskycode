...
namespace BraceMatchingVSIX
{
	...
	{
		public const string MyContentType = "aspwithbrace";

		[Export]
		[Name(MyContentType)]
		//[BaseDefinition("html (web forms)")] //non
		//[BaseDefinition("web forms")] //no
		[BaseDefinition("html")]    //nada ? work ?
									//[BaseDefinition("HTML")]    //work
									//[BaseDefinition("text")]	//not with [FileExtension(".asp")]
									//[BaseDefinition("code")]    //nein
	...
	//[ContentType("text")] //ok
	[ContentType(FileAndContentTypeDefinitions.MyContentType)] //test
															   //[ContentType("text/html")] //nope
															   //[ContentType("html")] //bof
															   //[FileExtension(".asp")] //bof
															   //[Order(Before = Priority.Default)] // Set the priority to be after the default classifiers
															   //[Order(Before = Priority.High, After = Priority.High)] // Set the priority to be after the default classifiers
	...
	internal class BraceMatchingTaggerProvider : IViewTaggerProvider
	{
		public ITagger<T> CreateTagger<T>(ITextView textView, ITextBuffer buffer) where T : ITag
		{
			...
			//désactivé sinon on ne va pas plus loin
