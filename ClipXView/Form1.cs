...
namespace ClipXView
{
	public partial class Form1 : Form
	{
		...
		public Form1(string[] args)
		{
			...
			//path = Path.Combine(Application.UserAppDataPath, "ClipX", "Storage");
			//path = @"E:\Users\yvan.kalafatov\AppData\Local\Temp";

			//string path = @"C:\Users\Lusky\AppData\Local\ClipX\Storage";
			string path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "ClipX", "Storage");
